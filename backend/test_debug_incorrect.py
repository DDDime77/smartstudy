#!/usr/bin/env python3
"""
Debug Test for Incorrect Tasks
"""
...
def main():
    print("=" * 80)
    print("DEBUG TEST: INCORRECT TASKS")
    print("=" * 80)
    ...
    # Use a NEW topic to test early learning
    topic = "Number Theory"
    difficulty = "medium"

    print(f"Testing with: {topic} {difficulty}")
    print(f"Completing 5 tasks INCORRECTLY\n")
    ...
    print("\n" + "=" * 80)
    print("Check backend logs for [Adaptive] debug output")
    print("=" * 80)
