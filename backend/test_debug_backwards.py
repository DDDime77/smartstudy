#!/usr/bin/env python3
"""
Debug script to understand backwards adaptation bug
"""
...
def main():
    print("=" * 80)
    print("DEBUG: INCORRECT TASKS SCENARIO")
    print("=" * 80)
    ...
    # Use a BRAND NEW topic for clean slate
    topic = "Set Theory"
    difficulty = "easy"

    print(f"Topic: {topic} {difficulty}")
    print(f"Completing 8 tasks INCORRECTLY (40s each)\n")
    ...
    for i in range(8):
        ...
        print(f"Task {i+1}: Pred={pred_acc:5.1%}, Time={pred_time:3.0f}s | Completing: INCORRECT ✗, 40s")
    ...
    print("  - Accuracy predictions should DECREASE over time")
    print("  - Time predictions should stay relatively stable")
    print("=" * 80)
